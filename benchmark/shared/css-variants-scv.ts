...
export const cssVariantsScvBaseOnly = scv({
  base: {
...
export const cssVariantsScvSingleVariant = scv({
  base: {
    icon: 'btn-icon',
    root: 'btn'
  },
...
export const cssVariantsScvMultipleVariants = scv({
  base: {
    description: 'text-sm',
    icon: 'shrink-0',
...
export const cssVariantsScvWithDefaults = scv({
  base: {
    input: 'form-input',
    label: 'form-label',
    root: 'form-field'
...
export const cssVariantsScvCompoundVariants = scv({
  base: {
    content: 'btn-content',
    icon: 'btn-icon',
...
export const cssVariantsScvComplexCard = scv({
  base: {
...
export const cssVariantsScvNoVariants = scv({
  base: {
    content: 'content',
    root: 'container'
  },
